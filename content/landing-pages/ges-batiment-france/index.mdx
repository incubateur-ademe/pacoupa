...
<div className="grid place-content-center grid-col-1 md:grid-cols-3 mt-2 gap-8">
    <Card>
      <Card.Title><img src="/landing/leaf.svg" className="w-[80px] h-[80px]"/><br/>Adoption de comportements de sobriété énergétique</Card.Title>
    ...
    <Card>
      <Card.Title><img src="/landing/house.svg" className="w-[80px] h-[80px]"/><br/>Isolation thermique</Card.Title>
      <Card.Body>
    ...
    <Card>
      <Card.Title><img src="/landing/environment.svg" className="w-[80px] h-[80px]"/><br/>Installation de systèmes de chauffage décarbonés</Card.Title>
      <Card.Body>
