...
<div className="grid grid-col-1 md:grid-cols-[1fr_minmax(100px,_200px)] gap-8">
  ...
  <div className="space-y-8">
    <Details>
      <Details.Question>1. L’augmentation des prix de l'énergie</Details.Question>
      <Details.Answer>
    ...
    <Details>
      <Details.Question>2. Les réglementations et les lois</Details.Question>
      <Details.Answer>
    ...
    <Details>
      <Details.Question>3. La conscience écologique croissante</Details.Question>
      <Details.Answer>
    ...
    <Details>
      <Details.Question>4. Le confort et la nécessaire adaptation au changement climatique </Details.Question>
      <Details.Answer>
    ...
    <Details>
      <Details.Question>5. La disponibilité des aides publiques</Details.Question>
      <Details.Answer>
