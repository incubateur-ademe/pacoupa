...
export const solution = {
    ...
    text: [
        {
          ...
          contenu: "La pompe à chaleur utilise une énergie décarbonée (l’électricité). Son rendement est, en moyenne, trois fois supérieur à celui d’un radiateur électrique ou d’une chaudière. Attention cependant à son utilisation en climatisation qui peut consommer beaucoup d’énergie et rejette de l’air chaud à l’extérieur."
        },
        {
          titre: "Entretien",
    ...
    text: [
      {
        ...
        contenu: "Une pompe à chaleur (PAC) Air / Air est composée d’une unité extérieure, qui capte les calories sur l’air extérieur, et d’une unité intérieure (mono-split) ou de plusieurs (multi-split). Ces unités intérieures positionnées dans chaque pièce permettent de chauffer ou refroidir l’air à l’intérieur du logement."
      },
      {
        titre: "Structure",
    ...
    text: [
        {
          ...
          contenu: "Il faut prévoir la création d’un réseau de fluide frigorigène entre les unités extérieures et les unités intérieures qui sont disposées dans chaque logement."
        },
        {
  ...
  acoustique: {
    ...
    text: [
        ...
        {
          titre: "Acoustique",
          contenu: "Le bruit d’une PAC est couvert par les bruits ambiants la journée mais peut être gênant la nuit si l’unité est trop proche des chambres. Il existe des solutions pour diminuer l’impact sonore des unités extérieures, surtout si les unités extérieures sont positionnées sur les balcons."
        },
      ],
  },
  espaceExterieur: {
