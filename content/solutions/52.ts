...
export const solution = {
  ...
  travauxIndividuel: {
    ...
    text: [
      {
        titre: "Déroulement des travaux",
        contenu: "Des unités intérieures (avec notamment le ballon de stockage ECS) sont installées dans chaque logement."
      },
      {
  ...
  acoustique: {
    ...
    text: [
      ...
      {
        titre: "Acoustique",
        contenu: "Il faut prévoir un éventuel traitement acoustique du module extérieur (surtout si positionné sur le balcon). Le module intérieur a une puissance acoustique faible, il peut être intégré en cuisine."
      },
    ],
  },
  espaceExterieur: {
