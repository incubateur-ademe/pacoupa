    ...
    text: [
      {
        ...
        contenu:
          "Le DRV (Débit de Réfrigérant Variable) peut également produire de l’eau chaude pour l’Eau Chaude Sanitaire (ECS). Pour cela, il faudra prévoir un local technique qui abrite les ballons de stockage ECS et la régulation.",
      },
      {
        titre: "Structure",
        contenu:
