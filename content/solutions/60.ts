    ...
    text: [
      {
        ...
        contenu: "Une PAC eau-eau est présente dans chaque logement pour fournir du chauffage et de l’Eau Chaude Sanitaire (ECS). Cette PAC individuelle est raccordée sur une boucle d’eau collective alimentée par une PAC collective (ou une autre source : chauffage urbain, géothermie…)."
      },
      {
        titre: "Structure",
    ...
    text: [
      {
        ...
        contenu: "Certaines solutions pour le circuit d’eau collectif nécessitent une unité extérieure, d’autres non. Les PAC air / eau disposent d’une unité extérieure (posées sur le sol, en toiture, jardin ou terrasse), les PAC eau / eau en géothermie n’ont pas d’unité extérieure apparente."
      },
      {
