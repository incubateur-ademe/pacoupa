...
export const SolutionCard = ({ solution, informationBatiment, gestes, marker }: PropsWithChildren<Props>) => {
  return (
    <Card
      ...
      footer={
        <>
          <div className="flex gap-2 justify-between pb-2 mt-8 border-b-2 border-t-0 border-x-0 border-solid border-[#304436] hover:!border-[#80b990] hover:!text-[#80b990] active:!text-[#92e3a9] shadow-none px-0 font-bold">
