...
const Carousel = forwardRef<HTMLDivElement, CarouselProps & React.HTMLAttributes<HTMLDivElement>>(
...
const CarouselPrevious = forwardRef<HTMLButtonElement, React.HTMLProps<HTMLButtonElement>>(({ className }, ref) => {
...
const CarouselNext = forwardRef<HTMLButtonElement, React.HTMLProps<HTMLButtonElement>>(({ className }, ref) => {
