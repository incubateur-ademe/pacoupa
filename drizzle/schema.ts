...
export const bddEco = sqliteTable(
  "bdd_eco",
  {
    ...
    scenarioRenovationSysteme: text("scenario_renovation_systeme", { enum: enumScenarioRenovationSysteme }).notNull(),
    coutSolution01: integer("cout_solution_01").notNull(),
    coutSolution02: integer("cout_solution_02").notNull(),
    coutSolution03: integer("cout_solution_03").notNull(),
    coutSolution04: integer("cout_solution_04").notNull(),
    coutSolution05: integer("cout_solution_05").notNull(),
    coutSolution06: integer("cout_solution_06").notNull(),
    coutSolution07: integer("cout_solution_07").notNull(),
    coutSolution08: integer("cout_solution_08").notNull(),
    coutSolution10: integer("cout_solution_10").notNull(),
    coutSolution11: integer("cout_solution_11").notNull(),
    coutSolution12: integer("cout_solution_12").notNull(),
    coutSolution13: integer("cout_solution_13").notNull(),
    coutSolution15: integer("cout_solution_15").notNull(),
    coutSolution16: integer("cout_solution_16").notNull(),
    coutSolution20: integer("cout_solution_20").notNull(),
    coutSolution21: integer("cout_solution_21").notNull(),
    coutSolution22: integer("cout_solution_22").notNull(),
    coutSolution23: integer("cout_solution_23").notNull(),
    coutSolution25: integer("cout_solution_25").notNull(),
    coutSolution26: integer("cout_solution_26").notNull(),
    coutSolution30: integer("cout_solution_30").notNull(),
    coutSolution31: integer("cout_solution_31").notNull(),
    coutSolution32: integer("cout_solution_32").notNull(),
    coutSolution40: integer("cout_solution_40").notNull(),
    coutSolution50: integer("cout_solution_50").notNull(),
    coutSolution51: integer("cout_solution_51").notNull(),
    coutSolution52: integer("cout_solution_52").notNull(),
    coutSolution53: integer("cout_solution_53").notNull(),
    coutSolution54: integer("cout_solution_54").notNull(),
    coutSolution60: integer("cout_solution_60").notNull(),
    coutSolution61: integer("cout_solution_61").notNull(),
