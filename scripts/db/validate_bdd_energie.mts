...
const schema = z.array(
  z.object({
    ...
    etat_isolation_menuiseries_apres_scénario_renovation_enveloppe: z.enum(["Pas isolé", "Isolé"]),
    etat_isolation_plancher_bas_apres_scénario_renovation_enveloppe: z.enum(["Pas isolé", "Isolé"]),
    etat_isolation_plancher_haut_apres_scénario_renovation_enveloppe: z.enum(["Pas isolé", "Isolé"]),
    etat_isolation_murs_apres_scénario_renovation_enveloppe: z.enum(["Pas isolé", "Isolé"]),
